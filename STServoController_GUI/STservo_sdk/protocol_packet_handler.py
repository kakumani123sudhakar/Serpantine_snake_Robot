...
class protocol_packet_handler(object):
    def __init__(self, portHandler, protocol_end):
        ...
        self.tx_rx_lock = threading.Lock() # Initialize a lock for TxRx operations
    ...
    def txPacket(self, txpacket):
        ...
        # Remove is_using logic, rely on threading.Lock
        ...
        if total_packet_length > TXPACKET_MAX_LEN:
            # self.portHandler.is_using = False # Removed
        ...
        # tx packet
        with self.tx_rx_lock: # Acquire lock for port access
    ...
    def rxPacket(self):
        ...
        while True:
            with self.tx_rx_lock: # Acquire lock for port access during read
